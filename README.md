...
The Swift wrappers have been tested with glib-2.48, 2.52, 2.56, 2.58, 2.60, 2.62, and 2.64, and clutter 1.26.x.  They should work with higher versions, but YMMV.  Also make sure you have `gobject-introspection` and its `.gir` files installed.

#### Linux

##### Ubuntu

On Ubuntu 18.04 and 16.04, you can use the clutter that comes with the distribution.  Just install with the `apt` package manager:
